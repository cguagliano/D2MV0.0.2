 ...
 *
 */
public class ContourMilling extends Contour{
	
	private static HashSet contourEntities;
	private static int colorContour;
	public ContourMilling(){
		contourEntities=getContourMillingEntities();
	}
	
	public static HashSet getContourMillingEntities(){
		colorContour=1;
